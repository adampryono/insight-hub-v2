                ...
                <div className="flex w-full flex-col items-center gap-14 rounded-[20px] bg-background-section px-14 py-[58px] shadow-xs md:p-5 sm:gap-7">
                    <div className="flex w-[46%] flex-col items-center gap-2 md:w-full">
                        ...
                        <Heading
                            ...
                            as="h2"
                            className="self-stretch text-center !font-plusjakartasans text-[20px] font-extralight leading-[120%]"
                        >
                            Masukkan username dan password untuk mendaftarkan akun
                        </Heading>
                    </div>
                    <div className="flex w-[46%] flex-col gap-14 md:w-full sm:gap-7">
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-col items-start gap-1.5">
                                <Heading size="body_b4" as="h3" className="!font-plusjakartasans text-[20px] font-extralight">
                                    Username
                                </Heading>
                                <Input
                                    size="md"
                            ...
                            <div className="flex flex-col items-start gap-1.5">
                                <Heading size="body_b4" as="h4" className="!font-plusjakartasans text-[20px] font-extralight">
                                    Password
                                </Heading>
                                <Input
                                    size="md"
                            ...
                            <div className="flex flex-col items-start gap-1.5">
                                <Heading size="body_b4" as="h5" className="!font-plusjakartasans text-[20px] font-extralight">
                                    Confirm Password
                                </Heading>
                                <Input
                                    size="md"
